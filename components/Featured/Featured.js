        ...
        <Grid container spacing={6}>
          ...
          <Grid item lg={5} md={10} xs={12}>
            ...
            >
              <div>
                <Title
                  head={t('veil-landing.featured_title')}
                  desc={t('veil-landing.featured_subtitle')}
                />
                <Typography display="block" className={text.paragraph}>
                  {t('veil-landing.featured_desc1')}
                </Typography>
                <br />
                <Typography display="block" className={text.paragraph}>
                  {t('veil-landing.featured_desc2')}
                </Typography>
              </div>
            </ScrollAnimation>
          </Grid>
